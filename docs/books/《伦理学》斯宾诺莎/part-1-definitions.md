...
**I.** By that which is **self-caused** (*causa sui*), I mean that of which the essence involves existence, or that of which the nature is only conceivable as existent.
...
> Explanation: Existence of this kind is conceived as an eternal truth, like the essence of a thing, and therefore cannot be explained by duration or time, even if the duration be conceived without beginning or end.
...
$$\text{Knowledge}(E) \implies \text{Knowledge}(C)$$
...
$$A \cap B = \emptyset \implies \text{Conception}(A) \not\to \text{Conception}(B)$$

**VI.** A true idea must agree with its ideate or object.
